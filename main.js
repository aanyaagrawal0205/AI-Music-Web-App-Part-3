...
function preload(){
    ...
    song_2 = loadSound("Billie_Eillish_bad_guy.mp3");
}
function setup(){
...
function draw(){
	...
	{ 
		...
		{
			song_2.play();
			document.getElementById("lbl_song_name").innerHTML = "Playing - Believer";
		}
	}
...
if(left_wrist_score > 0.2)
	{
		...
		{
			song.play();
			document.getElementById("lbl_song_name").innerHTML = "Playing - Bad Guy";
		}
	}
    }